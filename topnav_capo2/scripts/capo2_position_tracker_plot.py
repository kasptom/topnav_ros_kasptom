...
STRATEGY_TO_LABEL = {
    'N/A': 'N/A', 'DS_IDLE': 'Bezczynny', 'DS_RESTART': 'Restart', 'DS_ALONG_WALL_2': 'Jazda wzdluz sciany',
...
def plot_path_comparison(first_csv, second_scv, plot_file_name):
    flattened_logs = flatten_log(first_csv)
    entries = [convert_to_entry(entry) for entry in flattened_logs]

    flattened_logs_2 = flatten_log(second_scv)
    entries_2 = [convert_to_entry(entry) for entry in flattened_logs_2]

    sections = get_sections(entries)
    sections_2 = get_sections(entries_2)
    ...
    plot_sections(added_labels, axs, sections, subplot_placement=(0, 0))

    plot_sections(added_labels, axs, sections_2, subplot_placement=(0, 1))
...
plot_path_comparison('data/capo_position2019-08-01 02:58:1564621127.csv',
                     'data/capo_position2019-08-01 03:10:1564621857.csv',
                     'with_and_without_obstacles_2019-08-01.svg')

plot_path_comparison('data/capo_position2019-08-04 10:53:1564908808.csv',
